# code-with-quarkus-eventsourcing-kafka
...
You can then execute your native executable with: `./target/code-with-quarkus-eventsourcing-kafka-1.0.0-SNAPSHOT-runner`
